...
<body>
    <div style="padding: 20px;">
        <h1 style="text-align: center; color: #333">Account Verification Email!</h1>
        <p style="font-size: 13px; color: #333; margin: 0;">Hello, it seems that you're trying to register your account.</p>
