...
<head>
    ...
    <title>Campus Added to the Server</title>
</head>     
<body>
    <div style="padding: 20px;">
        <p style="font-size: 13px; color: #333; margin: 0;">Hello, this is to inform you that your campus with schoolid of: </p>
        <h2 style="background-color: #ccdaff; padding: 10px; border-radius: 5px; margin-top: -5px;">{{ $data }}</h2>
        <p style="font-size: 13px; margin-top: -10px; color: #333">has already been added to the server.</p>
