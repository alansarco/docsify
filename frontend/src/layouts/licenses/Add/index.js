                  ...
                  if(!formData.agreement) {
                        ...
                        try {
                              if (!token) {
                                    ...
                                    const response = await axios.post(apiRoutes.addLicense, formData, {headers});
                              ...
                              toast.error("Error adding license", { autoClose: true });
            ...
            <SoftBox mt={5} mb={3} px={2}>      
                  <SoftBox mb={5} p={4} className="shadow-sm rounded-4 bg-white">
                        ...
                        <ul className="text-danger fw-bold">
                              <li className="text-xxs fst-italic">Lincense keys are system generated 15 characters in length</li>
                              <li className="text-xxs fst-italic">Licenses are uneditable once created</li>
                              <li className="text-xxs fst-italic">You can't delete licenses when already used</li>
                        </ul>
                        <SoftBox mt={2}>
                              <SoftBox component="form" role="form" className="px-md-0 px-2" onSubmit={handleSubmit}>
                                    ...
                                    <Grid container spacing={0} alignItems="center">
                                          <Grid item xs={12}md={6} lg={4} px={1}>
                                                ...
                                                <SoftInput name="license_price" value={formData.license_price} onChange={handleChange} size="small" /> 
                                          </Grid> 
                                          <Grid item xs={12}md={6} lg={4} px={1}>
                                                <SoftTypography variant="button" className="me-1">Duration (days):</SoftTypography>
                                                <SoftTypography variant="span" className="text-xxs text-danger fst-italic">*</SoftTypography>
                                                <SoftInput name="license_duration" value={formData.license_duration} onChange={handleChange} size="small" /> 
                                          </Grid> 
                                    </Grid>
